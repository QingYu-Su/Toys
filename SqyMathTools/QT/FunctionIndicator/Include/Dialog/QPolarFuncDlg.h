#ifndef QPOLARFUNCDLG_H
#define QPOLARFUNCDLG_H
...
class QPolarFuncDlg : public QDialog
{
    Q_OBJECT

public:
    explicit QPolarFuncDlg(QString title, SML::MathExpression expression,
